// <copyright file="VehiclesRepositoryBase.cs" company="TryCatch Software Factory">
...
namespace TryCatch.EntityFrameworkCore.UnitTests.Mocks
{
    ...
    public class VehiclesRepositoryBase : RepositoryBase<Vehicle, VehiclesContext>
    {
        public VehiclesRepositoryBase(
